...
// ==========================================
// BANNERS DO TOPO (AGORA COM AS 4 FOTOS DE FUNDO)
// ==========================================
const bannersData = [
  {
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans overflow-x-hidden scroll-smooth">
      ...
      {/* ==========================================
          HERO (APENAS IMAGEM DE FUNDO E TEXTO CENTRALIZADO)
      ========================================== */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-6">
            <div className="grid grid-cols-2 gap-3">
              {Object.values(galeriaCampanha).map((foto, index) => (
                <div
                  key={index}
                ...
                >
                  {foto ? (
                    ...
                    <span className="text-xs text-white/30 text-center">[ FOTO {index + 1} ]</span>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="md:col-span-6 space-y-6 text-center md:text-right">
            <div>
              <h2 className="text-4xl font-black uppercase">Sobre a Campanha</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-gray-100 flex flex-col h-full">
              ...
              <div className="bg-[#8a0f0f] text-white p-6 flex-1">
                <p className="text-sm opacity-75 mb-3">
                  José Lucas, doutorando do Grupo de Pesquisa em Hematologia (UFS)
                </p>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-100 flex flex-col h-full">
              ...
              <div className="bg-[#8a0f0f] text-white p-6 flex-1 flex flex-col justify-center">
                <p className="text-sm opacity-75 mb-3">Camilla, estudante de graduação</p>
                <p className="italic text-sm md:text-base">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 w-full">
            ...
            <div className="flex items-center gap-4 bg-white/5 px-6 py-4 rounded-2xl backdrop-blur-sm border border-white/10 w-full max-w-[340px] shrink-0">
              ...
              <div className="leading-tight text-left">
                ...
                <p className="text-sm text-white/70">Design UX e UI da plataforma</p>
              </div>
            </div>
          </div>
        </div>
